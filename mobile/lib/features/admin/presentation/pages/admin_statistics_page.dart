      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildSectionTitle('Pertumbuhan User'),
                  _buildUserGrowthChart(),
                  const Gap(24),
                  _buildSectionTitle('Aktivitas User'),
                  _buildActivityCards(),
                  const Gap(24),
                  _buildSectionTitle('Traffic Penggunaan Aplikasi'),
                  _buildAppUsageChart(),
                  const Gap(24),
                  _buildSectionTitle('Distribusi User'),
                  _buildUserDistributionChart(),
                  const Gap(24),
                  _buildSectionTitle('Volume Laporan'),
                  _buildReportVolumeChart(),
                  const Gap(32),
                ],
              ),
            ),
