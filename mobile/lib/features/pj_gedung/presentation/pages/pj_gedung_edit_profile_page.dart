...
class PJGedungEditProfilePage extends StatefulWidget {
  ...
  @override
  State<PJGedungEditProfilePage> createState() => _PJGedungEditProfilePageState();
}
...
class _PJGedungEditProfilePageState extends State<PJGedungEditProfilePage> {
  ...
  Future<void> _saveProfile() async {
    ...
    final result = await authService.updateProfile(
      ...
      // Department/Faculty/Building are usually managed by Admin for staff, so we don't send them here to avoid accidental overrides
    );
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(12),
                    _ReadOnlyField(
                      label: 'Gedung Ditugaskan',
                      value: _currentUser!['managedBuilding'] ?? '-',
