...
/// All reports page with comprehensive filters and search
class TeknisiAllReportsPage extends StatefulWidget {
  ...
  @override
  State<TeknisiAllReportsPage> createState() => _TeknisiAllReportsPageState();
}

class _TeknisiAllReportsPageState extends State<TeknisiAllReportsPage> {
  ...
  void _initFilters() {
    if (widget.initialStatus != null) {
      final status = ReportStatus.values.firstWhere(
        (s) => s.name.toLowerCase() == widget.initialStatus!.toLowerCase(),
